...
def create_octo_table_func(my_cursor):
    sql = "CREATE TABLE Initial_Data_OCTO (octo_trxn_id VARCHAR(255), created_date VARCHAR(255), " \
...
def create_p2p_table_func(my_cursor):
    sql = "CREATE TABLE Initial_Data_P2P (time_id VARCHAR(255), customer_id VARCHAR(255), user_id VARCHAR(255), " \
